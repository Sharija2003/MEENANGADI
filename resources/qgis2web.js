...
map.getView().fit([8468227.461167, 1299175.984341, 8496837.286278, 1317388.000328], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MEENANGADI</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (157 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS A MAP OF MEENANGADI RESOURCE INFORMATION SYSTEM ICLUDING ALL THE BASIC DETAILS. THE DETIALS SPECIED ARE THE SCHOOLS, COMMUNITY HALL LOCATION ROAD ETC';
            }
